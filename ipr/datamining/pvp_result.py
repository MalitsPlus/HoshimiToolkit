...
#
#     result = pvp_result_from_dict(json.loads(json_string))
...
class ChallengeReward:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChallengeReward':
        assert isinstance(obj, dict)
        resource_id = from_none(obj.get("resourceId"))
        duplicate_reward_results = from_none(obj.get("duplicateRewardResults"))
        additional_gifts = from_none(obj.get("additionalGifts"))
        resource_type = from_union([from_int, from_none], obj.get("resourceType"))
        amount = from_union([from_int, from_none], obj.get("amount"))
        before_amount = from_union([from_int, from_none], obj.get("beforeAmount"))
        after_amount = from_union([from_int, from_none], obj.get("afterAmount"))
        ...
        return ChallengeReward(resource_id, duplicate_reward_results, additional_gifts, resource_type, amount, before_amount, after_amount, is_new, is_truncate, is_gift)

    def to_dict(self) -> dict:
        result: dict = {}
        result["resourceId"] = from_none(self.resource_id)
        result["duplicateRewardResults"] = from_none(self.duplicate_reward_results)
        result["additionalGifts"] = from_none(self.additional_gifts)
        result["resourceType"] = from_union([from_int, from_none], self.resource_type)
        result["amount"] = from_union([from_int, from_none], self.amount)
        result["beforeAmount"] = from_union([from_int, from_none], self.before_amount)
        result["afterAmount"] = from_union([from_int, from_none], self.after_amount)
        result["isNew"] = from_union([from_bool, from_none], self.is_new)
        result["isTruncate"] = from_union([from_bool, from_none], self.is_truncate)
...
class UpdatedData:
    ...
    def from_dict(obj: Any) -> 'UpdatedData':
        ...
        return UpdatedData(user, items, cards, costumes, accessories, photos, decks, deck_positions, stories, staffs, messages, telephones, profile, emblems, balance, total_count, areas, quests, gacha_buttons, home_talks, photo_report, card_supports, message_schedules, notifications, hierarchy, tutorials, home_positions, musics, decorations, characters, points, missions, character_musics)
...
class OpponentProfileProfile:
    ...
    def from_dict(obj: Any) -> 'OpponentProfileProfile':
        ...
        return OpponentProfileProfile(favorite_card, user_id, name, manager_exp, manager_level, emblem_id, favorite_photo, favorite_character_ids, background_type, layout_type, last_login_time, decoration_id)
...
class Failure:
    ...
    each_failure_types: Optional[List[int]] = None
    ...
    def from_dict(obj: Any) -> 'Failure':
        ...
        each_failure_types = from_union([from_none, lambda x: from_list(from_int, x)], obj.get("eachFailureTypes"))
        return Failure(card_index, type, each_failure_types)

    def to_dict(self) -> dict:
        result: dict = {}
        result["cardIndex"] = from_union([from_int, from_none], self.card_index)
        result["type"] = from_union([from_int, from_none], self.type)
        result["eachFailureTypes"] = from_union([from_none, lambda x: from_list(from_int, x)], self.each_failure_types)
        return result
...
class ActivatedSkill:
    ...
    def from_dict(obj: Any) -> 'ActivatedSkill':
        ...
        details = from_union([from_none, lambda x: from_list(Detail.from_dict, x)], obj.get("details"))
    ...
    def to_dict(self) -> dict:
        ...
        result["details"] = from_union([from_none, lambda x: from_list(lambda x: to_class(Detail, x), x)], self.details)
...
class Result:
    ...
    def from_dict(obj: Any) -> 'Result':
        ...
        return Result(user_infos, activated_passive_skills, charts, total_audience_amount, cleared)
...
class PvpResult:
    ...
    rank: Optional[int] = None
    challenge_rewards: Optional[List[ChallengeReward]] = None
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PvpResult':
        assert isinstance(obj, dict)
        ...
        rank = from_union([from_int, from_none], obj.get("rank"))
        challenge_rewards = from_union([lambda x: from_list(ChallengeReward.from_dict, x), from_none], obj.get("challengeRewards"))
        ...
        return PvpResult(music_mastery_rewards, result, point, add_point, rank, challenge_rewards, profile, opponent_profile, common_response)
    ...
    def to_dict(self) -> dict:
        ...
        result["rank"] = from_union([from_int, from_none], self.rank)
        result["challengeRewards"] = from_union([lambda x: from_list(lambda x: to_class(ChallengeReward, x), x), from_none], self.challenge_rewards)
...
def pvp_result_from_dict(s: Any) -> PvpResult:
    return PvpResult.from_dict(s)


def pvp_result_to_dict(x: PvpResult) -> Any:
    return to_class(PvpResult, x)
